...
By default, gapindex calculates age composition only for the EBS + NW
region. This is a case example of how you could calculate age
composition for the EBS Standard Region (excluding strata 82 and 90).
