...
Represented in Oracle as the `CPUE` table in the GOA or AI schema.
...
In the scripts in this project, this is calculated with the following lines:
...
### Stratum biomass
Represented in Oracle in the `BIOMASS_STRATUM` table in the GOA or AI schema.
